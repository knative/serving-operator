...
import (
	...
	operatorResources "knative.dev/serving-operator/test/resources"
...
func TestRunLatestServicePreUpgradeAndScaleToZero(t *testing.T) {
	...
	if err := operatorResources.WaitForScaleToZero(t, revisionresourcenames.Deployment(resources.Revision), clients,
		operatorTest.ServingOperatorNamespace); err != nil {
